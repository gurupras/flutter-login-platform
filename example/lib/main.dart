...
class _MyAppState extends State<MyApp> {
  ...
  final _libloginNativePlugin = LibloginNative();
  ...
  Future<void> getPlatformInfo() async {
    String platformInfo;
    try {
      platformInfo = await _libloginNativePlugin.getPlatformInfo() ??
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion =
          await _libloginNativePlugin.getPlatformVersion() ?? 'Unknown platform version';
    } on PlatformException {
